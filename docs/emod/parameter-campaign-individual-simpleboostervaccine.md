...
*See parameter table: [campaign-simpleboostervaccine.csv](../csv/campaign-simpleboostervaccine.csv)*

*See example: [campaign-simpleboostervaccine.json](../json/campaign-simpleboostervaccine.json)*
