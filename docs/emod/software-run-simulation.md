...
The EMOD executable (Eradication.exe) consumes the *input files*, *configuration file*, and, optionally,
*campaign file* to run simulations that model disease dynamics and campaign efficacy. The
...
information, see [emod:dev-regression](emod:dev-regression.md).
