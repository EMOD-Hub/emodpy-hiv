...
## Ubuntu 22.04 (Jammy Jellyfish) environment
...
### Regression test graphs differ when run on Ubuntu 22.04 (Jammy Jellyfish)

After you run regression simulations on Ubuntu 22.04 (Jammy Jellyfish) using runemod.sh in the Scripts directory, it plots
...
cases may be slightly different than the output from Ubuntu 22.04 (Jammy Jellyfish).
...
to run simulations on Ubuntu 22.04 (Jammy Jellyfish). See [installation](../installation.md).
