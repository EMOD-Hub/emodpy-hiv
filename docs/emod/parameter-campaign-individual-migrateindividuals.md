...
*See parameter table: [campaign-migrateindividuals.csv](../csv/campaign-migrateindividuals.csv)*

*See example: [campaign-migrateindividuals.json](../json/campaign-migrateindividuals.json)*
