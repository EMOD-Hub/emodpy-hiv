...
[emod-generic:parameter-campaign-node-birthtriggerediv](emod-generic:parameter-campaign-node-birthtriggerediv.md) in the context of a routine vaccination schedule, calendars
