...
*See parameter table: [campaign-delayedintervention.csv](../csv/campaign-delayedintervention.csv)*

*See example: [campaign-delayedintervention.json](../json/campaign-delayedintervention.json)*
